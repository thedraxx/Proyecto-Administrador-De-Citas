...
// AGREGA DATIS AL OBJETO DE CITAS citaObj
...
function eliminarCita(id) {
  ...
  //mostrar el mensaje
  ui.imprimirAlerta("la cita se elimino con exito");
  //refrescar la cita
  ui.imprimirCitas(administrarCitas);
}
